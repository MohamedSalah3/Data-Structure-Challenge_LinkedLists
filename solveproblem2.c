...
{int i=0,sum=0;
  // ar=(int*)calloc(ar_count,sizeof(int));
   
   for(i=0;i<ar_count;i++)
{
     sum=sum+ar[i];
    printf("sum is%d %d",sum,ar[i]);
}
return sum;
}
...
int main()
{
    FILE* fptr = fopen("OUTPUT_of_solveproblem2.txt", "w");
    ...
    fprintf(fptr, "the result of this program solveproblem2.c= %d\n", result);
