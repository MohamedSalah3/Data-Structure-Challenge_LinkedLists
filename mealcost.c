...
double operand_tip=(double)tip_percent/100;
double operand_tax=(double)tax_percent/100;
double Total_cost= meal_cost+operand_tip*meal_cost+meal_cost*operand_tax;
__ceil(Total_cost);
